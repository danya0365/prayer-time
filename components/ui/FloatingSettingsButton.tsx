      ...
      <div className="fixed bottom-6 right-6 z-30 flex flex-col space-y-4">
        ...
        <div className="relative group">
          <button
            ...
            className="w-14 h-14 bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center backdrop-blur-sm border border-white/20"
