...
export default function HeroSection({ 
  ...
  const getLocationDisplayText = () => {
    ...
    return currentLocation.address || `${currentLocation.latitude.toFixed(2)}, ${currentLocation.longitude.toFixed(2)}`;
  };
    ...
    <section className="w-full max-w-4xl mx-auto">
      ...
      <div className="relative bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 rounded-3xl p-8 mb-8 text-white overflow-hidden">
        ...
        <div className="absolute top-4 right-4">
          <SettingsButton onClick={onSettingsClick || (() => {})} variant="light" />
        </div>
        ...
        <div className="absolute top-4 left-4">
          ...
          >
            ...
            <span className="hidden sm:inline truncate max-w-32">{getLocationDisplayText()}</span>
        ...
        <div className="relative z-10 text-center">
          <div className="mb-6">
            <p className="text-white/80 text-lg font-medium mb-2">{formattedDate}</p>
