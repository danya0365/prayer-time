...
export const th: Translations = {
  ...
  qibla: {
    ...
    calibrationTitle: "ปรับเทียบเข็มทิศของคุณ",
    calibrationDesc: "เพื่อให้ได้ความแม่นยำสูงสุด โปรดขยับโทรศัพท์เป็นรูปเลข 8",
    calibrationStatus: "กำลังตรวจจับการเคลื่อนไหว... {progress}%",
    skipCalibration: "ข้ามการปรับเทียบ",
  },

  qiblaGuide: {
    title: "คู่มือเข็มทิศกิบลัต",
    subtitle: "ทำตามคำแนะนำเหล่านี้เพื่อให้ได้ทิศกิบลัตที่แม่นยำที่สุด",
    startButton: "เริ่มต้น",
    nextButton: "ถัดไป",
    prevButton: "ย้อนกลับ",
    doneButton: "เริ่มหาทิศกิบลัต",
    dontShowAgain: "ไม่ต้องแสดงอีก",
    steps: [
      {
        title: "เปิดการเข้าถึงตำแหน่ง",
        description: "ตำแหน่ง GPS ที่แม่นยำเป็นพื้นฐานสำคัญ ทิศกิบลัตจะคำนวณจากตำแหน่งของคุณไปยังมักกะฮ์",
        icon: "📍",
        tips: [
          "อนุญาตการเข้าถึงตำแหน่งเมื่อระบบถาม",
          "ออกไปข้างนอกหรืออยู่ใกล้หน้าต่างเพื่อรับสัญญาณ GPS ที่ดีที่สุด",
          "Wi-Fi และข้อมูลมือถือช่วยเพิ่มความแม่นยำของตำแหน่ง"
        ]
      },
      {
        title: "ปรับเทียบเข็มทิศ",
        description: "เซนเซอร์แม่เหล็กในโทรศัพท์ต้องได้รับการปรับเทียบเพื่อตรวจจับทิศเหนือได้อย่างแม่นยำ สัญญาณรบกวนอาจทำให้อ่านค่าผิดพลาด",
        icon: "🔄",
        tips: [
          "ขยับโทรศัพท์เป็นรูปเลข 8 ช้าๆ 3-4 ครั้ง",
          "หมุนตามแกนทุกแกน (เอียง หมุน และบิด)",
          "ปรับเทียบใหม่หากทิศทางดูไม่ถูกต้อง"
        ]
      },
      {
        title: "ระวังสภาพแวดล้อม",
        description: "สนามแม่เหล็กจากวัตถุใกล้เคียงสามารถบิดเบือนเข็มทิศได้ แม้แหล่งรบกวนเล็กน้อยก็มีผล",
        icon: "⚠️",
        tips: [
          "ย้ายออกจากวัตถุโลหะ ลำโพง และแม่เหล็ก",
          "ถอดเคสโทรศัพท์แม่เหล็กหรือฝาครอบโลหะ",
          "ถอยห่างจากอุปกรณ์อิเล็กทรอนิกส์ รถยนต์ และโครงสร้างเหล็ก"
        ]
      },
      {
        title: "ถืออุปกรณ์ให้ถูกต้อง",
        description: "เซนเซอร์เข็มทิศทำงานดีที่สุดเมื่อถือโทรศัพท์ให้แบนขนานกับพื้น",
        icon: "📱",
        tips: [
          "ถือโทรศัพท์แบนเหมือนถาด",
          "ให้ขนานกับพื้น ไม่เอียง",
          "หลีกเลี่ยงการเคลื่อนไหวขณะอ่านทิศทาง"
        ]
      },
      {
        title: "โหมดปรับเองเมื่อจำเป็น",
        description: "หากเข็มทิศไม่ทำงานบนอุปกรณ์ของคุณ (พบได้บ่อยบน Android บางรุ่นและเดสก์ท็อปทุกเครื่อง) คุณสามารถตั้งค่าทิศเหนือเองได้",
        icon: "🧭",
        tips: [
          "ใช้เข็มทิศอื่นหรือจุดสังเกตที่รู้จักเพื่อหาทิศเหนือ",
          "สลับไปที่ 'โหมดปรับเอง' แล้วเลื่อนแถบไปที่ทิศเหนือจริง",
          "ตรวจสอบกับ Google Maps: ทิศเหนืออยู่ด้านบนของแผนที่เสมอ"
        ]
      }
    ]
  }
