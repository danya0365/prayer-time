...
export const th: Translations = {
  ...
  qibla: {
    ...
    manualAdjustment: "การปรับทิศทางด้วยตนเอง",
    manualMode: "โหมดปรับเอง",
    sensorMode: "โหมดเข็มทิศอัตโนมัติ",
    overrideDesc: "ข้ามการใช้เซนเซอร์เครื่อง",
    adjustHeading: "ปรับทิศทางเข็มทิศ (องศา)",
    resetOrientation: "ล้างค่าทิศทาง",
    orientationHint: "หากคุณทราบทิศเหนือจริง คุณสามารถปรับแถบด้านล่างเพื่อให้เข็มทิศตรงกับสถานที่จริงได้ครับ"
  }
};
